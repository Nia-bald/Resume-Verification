...
class Network(object):
    ...
    def update_mini_batch(self, mini_batch, eta):
        ...
        for x, y in mini_batch:
            """calculates the d/dvC(xi) for xi which currently running in loop for all weights and biases
                remember nabla_v, delta_nabla_v, are still list of numpy array, each array representing a layer
                each array has lists each list representing neurons and element in the list representing the 
                delta_v, delta_nabla_v values we keep adding delta nabla v to it
                """
